...
phon <- read.delim("W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/phonotactics.txt")
phon = phon[,-c(2:4)]  # spalten  entfernen, da schon in compiled_4
voctest <- read.delim("W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/day2_part2(voctest)/results_voctest_xp2.txt", header=F)
lextale <- read.delim("W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/day2_part4(lextale)/results_lexTALE_all_xp2.txt", header=T)
self_scores <- read.delim("W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/pp_questinf_xp2.txt")
...
d.sub.01 = merge(d.sub.01, voctest.results[,3:4], by.x = "subject_set", by.y = "subject_set", all.x = TRUE)
...
d.sub.01.match = subset(d.sub.01, is_target == "yes")
table.sets.correct = xtabs(~correctness + set, data = d.sub.01.match);table.sets.correct
...
d.sub.02 = subset(d.sub.01, !(set %in% c("t04","t07", "t11", "t13")))
...
write.table(d.sub.05, 'W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/R/output/d.sub05.txt', sep = "\t", row.names = FALSE)
write.table(d.sub.06, 'W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/R/output/d.sub06.txt', sep = "\t", row.names = FALSE)
write.table(transcr_task.sub, 'W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/day2_part3(transcription)/xp2.transcr.all.sub.txt', sep = "\t", row.names = FALSE, quote = F)
write.table(subset(transcr_task.sub, group == 1)[c(1,2,3,10,7)], 'W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/day2_part3(transcription)/xp2.transrc.sub.group1.txt', sep = "\t", row.names = FALSE, quote = F)
write.table(subset(transcr_task.sub, group == 2)[c(1,2,3,10,7)], 'W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/day2_part3(transcription)/xp2.transrc.sub.group2.txt', sep = "\t", row.names = FALSE, quote = F)
write.table(subset(transcr_task.sub, group == 2 & p_dutch == "I")[c(1,2,3,10,7)], 'W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/day2_part3(transcription)/xp2.transcr.sub.group2.ill.txt', sep = "\t", row.names = FALSE, quote = F)
write.table(subset(transcr_task.sub, group == 2 & p_dutch == "L")[c(1,2,3,10,7)], 'W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/day2_part3(transcription)/xp2.transcr.sub.group2.l.txt', sep = "\t", row.names = FALSE, quote = F)
write.table(subset(transcr_task.sub, group == 1 & p_dutch == "I")[c(1,2,3,10,7)], 'W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/day2_part3(transcription)/xp2.transcr.sub.02.group1.ill.txt', sep = "\t", row.names = FALSE, quote = F)
write.table(subset(transcr_task.sub, group == 1 & p_dutch == "L")[c(1,2,3,10,7)], 'W:/EXPERIMENTS/AUDITORY_RESTORED/REDUCTIES/SASCHA/Study_1/main experiment/Results - Compiled/xp2/day2_part3(transcription)/xp2.transcr.sub.02.group1.l.txt', sep = "\t", row.names = FALSE, quote = F)
